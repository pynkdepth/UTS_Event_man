...
const RegisterWebPage: React.FC = () => {
  ...
  const handleCloseModal = () => {
    ...
    navigate("/competition/web-design"); 
  };
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append("competition", "WEB");
